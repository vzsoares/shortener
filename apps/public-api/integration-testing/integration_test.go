...
func Test_GetHandler_RedirectNotFound(t *testing.T) {
	...
	if location != tools.Consts.GetConst("DEFAULT_NOT_FOUND_PAGE") {
		t.Errorf("expected to be %v got %v", tools.Consts.GetConst("DEFAULT_NOT_FOUND_PAGE"), location)
	}
}
...
func Test_GetHandler_RedirectError(t *testing.T) {
	...
	if location != tools.Consts.GetConst("DEFAULT_ERROR_PAGE") {
		t.Errorf("expected to be %v got %v", tools.Consts.GetConst("DEFAULT_ERROR_PAGE"), location)
	}
}
